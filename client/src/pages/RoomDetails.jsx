...
const RoomDetails = () => {
    ...
    const hotels = useMemo(() => room ? [room.hotel] : [], [room])
    ...
    return room && (
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <div className='flex flex-col md:flex-row items-start md:items-center gap-2'>
                <h1 className='text-3xl ms:text-4xl font-playfair'>{room.hotel.name} <span className='font-inter text-sm'>({room.roomType})</span></h1>
            ...
            {/* Room Address */}
            <div className='flex items-center gap-1 text-gray-500  mt-'>
            ...
            <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-5 rounded-xl mx-auto mt-16 max-w-6xl' >
                <div className='flex -flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
                    ...
                    <div className='flex flex-col'>
                        <label htmlFor="checkIOutDate" className='font-medium'>Check-Out</label>
            ...
            <div className='mt-25 space-y-4'>
                {roomCommonData.map((specs, index) => (
                    <div key={index} className='flex items-start gap-2'>
                        ...
                        <div>
                            <p className='text-base'>{specs.description}</p>
                            <p className='text-gray-500'>{specs.title}</p>
                        </div>
                    </div>
                ))}
            </div>
            ...
            {/* Hotel Location */}
            <div className='mt-10'>
                <h2 className='text-2xl font-playfair mb-4'>Location</h2>
                <LocationMap hotels={hotels} />
            </div>
