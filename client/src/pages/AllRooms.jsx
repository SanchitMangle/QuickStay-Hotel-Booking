...
const CheckBox = ({ label, selected = false, onChange = () => { } }) => {
    return (
        <label className='flex gap-3 items-center cursor-pointer mt-2 text-sm'>
            ...
            <sam className='font-light select-none'>{label}</sam>
        </label>
    )
}
...
const AllRooms = () => {
    ...
    return (
        <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-20 md:pt-28 px-4 md:px-16 lg:px-24 xl:px-32'>
            <div>
